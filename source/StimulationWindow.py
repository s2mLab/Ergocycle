...
class StimulationWindow(QWidget):
    def __init__(self, current_parameters):
        ...
        self.end_of_stim = None
        self.end_of_stim = None
        self.update_parameters = None
        self.end_of_stim = None
        self.min = None
        self.sec = None
        self.stim_training_length_sec = None
        self.decrease_imp8_button = None
        self.decrease_imp7_button = None
        self.decrease_imp6_button = None
        self.decrease_imp5_button = None
        self.decrease_imp4_button = None
        self.decrease_imp3_button = None
        self.decrease_imp2_button = None
        self.decrease_imp1_button = None
        self.increase_imp8_button = None
        self.increase_imp7_button = None
        self.increase_imp6_button = None
        self.increase_imp5_button = None
        self.increase_imp4_button = None
        self.increase_imp3_button = None
        self.increase_imp2_button = None
        self.increase_imp1_button = None
        self.decrease_frequency8_button = None
        self.decrease_frequency7_button = None
        self.decrease_frequency6_button = None
        self.decrease_frequency5_button = None
        self.decrease_frequency4_button = None
        self.decrease_frequency3_button = None
        self.decrease_frequency2_button = None
        self.decrease_frequency1_button = None
        self.increase_frequency8_button = None
        self.increase_frequency7_button = None
        self.increase_frequency6_button = None
        self.increase_frequency5_button = None
        self.increase_frequency4_button = None
        self.increase_frequency3_button = None
        self.increase_frequency2_button = None
        self.increase_frequency1_button = None
        self.decrease_amplitude8_button = None
        self.decrease_amplitude7_button = None
        self.decrease_amplitude6_button = None
        self.decrease_amplitude5_button = None
        self.decrease_amplitude4_button = None
        self.decrease_amplitude3_button = None
        self.decrease_amplitude2_button = None
        self.decrease_amplitude1_button = None
        self.increase_amplitude8_button = None
        self.increase_amplitude7_button = None
        self.increase_amplitude6_button = None
        self.increase_amplitude5_button = None
        self.increase_amplitude4_button = None
        self.increase_amplitude3_button = None
        self.increase_amplitude2_button = None
        self.increase_amplitude1_button = None
        self.current_imp_label8_label = None
        self.current_imp_label7_label = None
        self.current_imp_label6_label = None
        self.current_imp_label5_label = None
        self.current_imp_label4_label = None
        self.current_imp_label3_label = None
        self.current_imp_label2_label = None
        self.current_imp_label1_label = None
        self.current_frequency8_label = None
        self.current_frequency7_label = None
        self.current_frequency6_label = None
        self.current_frequency5_label = None
        self.current_frequency4_label = None
        self.current_frequency3_label = None
        self.current_frequency2_label = None
        self.current_frequency1_label = None
        self.current_frequency4_label = None
        self.current_amplitude8_label = None
        self.current_amplitude7_label = None
        self.current_amplitude6_label = None
        self.current_amplitude5_label = None
        self.current_amplitude4_label = None
        self.current_amplitude3_label = None
        self.current_amplitude2_label = None
        self.current_amplitude1_label = None
        self.electrode8_label = None
        self.electrode7_label = None
        self.electrode6_label = None
        self.electrode5_label = None
        self.electrode4_label = None
        self.electrode3_label = None
        self.electrode2_label = None
        self.electrode1_label = None
        self.length_imp_label = None
        self.frequency_label = None
        self.amplitude_label = None
        self.pauseWatch = None
        self.startWatch = None
        ...
        # 1.1. Set size, background colour and title of instruction window
        self.setGeometry(0, 30, SCREEN_WIDTH, SCREEN_HEIGHT - 30)
        self.setWindowTitle("Menu des stimulations")
        self.setStyleSheet("background-color: white;")
        self.init_ui(current_parameters)

    def init_ui(self, current_parameters):
        # 1.1. Place S2M logo in the left corner of the window
        ...
        # 1.2. Simulation menu title
        self.menu_label = QtWidgets.QLabel(self)
        self.menu_label.setText("Stimulation en cours...")
        ...
        # 1.4.2. Timer object
        timer = QTimer(self)
        timer.timeout.connect(self.show_counter)
        timer.start(100)
        # 1.5. Layout of stimulation window's labels
        ...
        # 1.8. Place all amplitudes depending on the electrode
        ...
        # 1.9. Place all frequency depending on the electrode
        ...
        # 1.10. Place all impulsion duration depending on the electrode
        ...
        # 1.11 Place "+" and "-" button for amplitude
        # 1.11.1 "+" amplitude
        ...
        # 1.12 - Place "+" and "-" button for frequency
        # 1.12.1 "+" frequency
        ...
        # 1.13 Place "+" and "-" for impulsion duration
        # 1.13.1 "+" impulsion duration
    ...
    def check_if_off(self, current_parameters):
        if (
            (int(current_parameters.electrode1_amplitude) == 0)
            and (int(current_parameters.electrode1_frequency) == 0)
            and (int(current_parameters.electrode1_length_imp) == 0)
        ):
        ...
        if (
            (int(current_parameters.electrode2_amplitude) == 0)
            and (int(current_parameters.electrode2_frequency) == 0)
            and (int(current_parameters.electrode2_length_imp) == 0)
        ):
        ...
        if (
            (int(current_parameters.electrode3_amplitude) == 0)
            and (int(current_parameters.electrode3_frequency) == 0)
            and (int(current_parameters.electrode3_length_imp) == 0)
        ):
        ...
        if (
            (int(current_parameters.electrode4_amplitude) == 0)
            and (int(current_parameters.electrode4_frequency) == 0)
            and (int(current_parameters.electrode4_length_imp) == 0)
        ):
        ...
        if (
            (int(current_parameters.electrode5_amplitude) == 0)
            and (int(current_parameters.electrode5_frequency) == 0)
            and (int(current_parameters.electrode5_length_imp) == 0)
        ):
        ...
        if (
            (int(current_parameters.electrode6_amplitude) == 0)
            and (int(current_parameters.electrode6_frequency) == 0)
            and (int(current_parameters.electrode6_length_imp) == 0)
        ):
        ...
        if (
            (int(current_parameters.electrode7_amplitude) == 0)
            and (int(current_parameters.electrode7_frequency) == 0)
            and (int(current_parameters.electrode7_length_imp) == 0)
        ):
        ...
        if (
            (int(current_parameters.electrode8_amplitude) == 0)
            and (int(current_parameters.electrode8_frequency) == 0)
            and (int(current_parameters.electrode8_length_imp) == 0)
        ):
    ...
    # 1.14. Get the label value changed by the user with + and - button for sending it to communication module
        ...
        for i in range(len(self.update_parameters)):
            if i == 0:
                self.update_parameters[i, :] = [
                    current_parameters.get_electrode1_amplitude(),
                    current_parameters.get_electrode2_amplitude(),
                    current_parameters.get_electrode3_amplitude(),
                    current_parameters.get_electrode4_amplitude(),
                    current_parameters.get_electrode5_amplitude(),
                    current_parameters.get_electrode6_amplitude(),
                    current_parameters.get_electrode7_amplitude(),
                    current_parameters.get_electrode8_amplitude(),
                ]
            if i == 1:
                self.update_parameters[i, :] = [
                    current_parameters.get_electrode1_frequency(),
                    current_parameters.get_electrode2_frequency(),
                    current_parameters.get_electrode3_frequency(),
                    current_parameters.get_electrode4_frequency(),
                    current_parameters.get_electrode5_frequency(),
                    current_parameters.get_electrode6_frequency(),
                    current_parameters.get_electrode7_frequency(),
                    current_parameters.get_electrode8_frequency(),
                ]
            if i == 2:
                self.update_parameters[i, :] = [
                    current_parameters.get_electrode1_length_imp(),
                    current_parameters.get_electrode2_length_imp(),
                    current_parameters.get_electrode3_length_imp(),
                    current_parameters.get_electrode4_length_imp(),
                    current_parameters.get_electrode5_length_imp(),
                    current_parameters.get_electrode6_length_imp(),
                    current_parameters.get_electrode7_length_imp(),
                    current_parameters.get_electrode8_length_imp(),
                ]
            if i == 3:
    ...
    def show_counter(self):
        ...
        # Merge the minute, second and count values
    ...
    # 1.15. Change of button label and change of button functionality for starting or pausing stimulation
    ...
    # 1.15. Put all + and - button to off. Avoid any change during  the training pause
    ...
    # 1.16. Reactivate all + and - button when stimulation resume
