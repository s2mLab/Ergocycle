...
class Crankset:
    ...
    # Array G for left and right pedal ###
    gL = np.array(
        [
            [-34.38040, -15.98861, 14.85417, 38.92416, 21.79468, -16.54527],
    ...
    gR = np.array(
        [
            [39.69498, 20.12129, -19.50629, -34.57358, -11.88828, 17.41444],
    ...
    def read_card():
        ...
        task1 = nidaqmx.Task()  # Create a task to be used
    ...
    def read_angle():
        ...
        task2 = nidaqmx.Task()  # Create a task that collect the angle
    ...
    @staticmethod
    def multiple_gu(mat, vec):
        force = np.matmul(mat, vec)
        return force
    ...
    def get_average_moment(self):
        return -1 if self.force_vector is None else ((self.force_vector[6] + self.force_vector[12]) / 2)
