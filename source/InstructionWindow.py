...
MAX_TRAINING_LENGTH = 120  # TODO: add to constants.py
...
class InstructionWindow(QWidget):
    def __init__(self, init_parameters):
        ...
        self.muscle8_label = None
        self.electrode8_label = None
        self.muscle7_label = None
        self.electrode7_label = None
        self.muscle6_label = None
        self.electrode6_label = None
        self.muscle5_label = None
        self.electrode5_label = None
        self.muscle4_label = None
        self.electrode4_label = None
        self.muscle3_label = None
        self.electrode3_label = None
        self.muscle2_label = None
        self.electrode2_label = None
        self.muscle1_label = None
    ...
    def init_ui(self, init_parameters):
        # 1.1. Place the S2M logo in the left corner of the window
        ...
        self.muscle1_label = QtWidgets.QLabel(self)
        ...
        self.muscle2_label = QtWidgets.QLabel(self)
        ...
        self.muscle3_label = QtWidgets.QLabel(self)
        ...
        self.muscle4_label = QtWidgets.QLabel(self)
        ...
        self.muscle5_label = QtWidgets.QLabel(self)
        ...
        self.muscle6_label = QtWidgets.QLabel(self)
        ...
        self.muscle7_label = QtWidgets.QLabel(self)
        ...
        self.muscle8_label = QtWidgets.QLabel(self)
        ...
        # 1.4. Search user value entered in MainWindowStim.py in order to send them to the communication module
    ...
    def get_initial_parameters(self, init_parameters):
        for i in range(len(self.start_parameters)):
            if i == 0:
                self.start_parameters[i, :] = [
                    init_parameters.get_electrode1_amplitude(),
                    init_parameters.get_electrode2_amplitude(),
                    init_parameters.get_electrode3_amplitude(),
                    init_parameters.get_electrode4_amplitude(),
                    init_parameters.get_electrode5_amplitude(),
                    init_parameters.get_electrode6_amplitude(),
                    init_parameters.get_electrode7_amplitude(),
                    init_parameters.get_electrode8_amplitude(),
                ]
            if i == 1:
                self.start_parameters[i, :] = [
                    init_parameters.get_electrode1_frequency(),
                    init_parameters.get_electrode2_frequency(),
                    init_parameters.get_electrode3_frequency(),
                    init_parameters.get_electrode4_frequency(),
                    init_parameters.get_electrode5_frequency(),
                    init_parameters.get_electrode6_frequency(),
                    init_parameters.get_electrode7_frequency(),
                    init_parameters.get_electrode8_frequency(),
                ]
            if i == 2:
                self.start_parameters[i, :] = [
                    init_parameters.get_electrode1_length_imp(),
                    init_parameters.get_electrode2_length_imp(),
                    init_parameters.get_electrode3_length_imp(),
                    init_parameters.get_electrode4_length_imp(),
                    init_parameters.get_electrode5_length_imp(),
                    init_parameters.get_electrode6_length_imp(),
                    init_parameters.get_electrode7_length_imp(),
